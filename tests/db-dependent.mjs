...
/**
 * Eval del RAG (F1-12). Necesita `DATABASE_URL` (y `VOYAGE_API_KEY`; sin ella se
 * saltea). Tiene su propio config (`npm run eval:rag`), NO va con `test:integration`.
 */
export const EVAL_RAG = ['tests/rag/eval.test.ts'];

export const TESTS_CON_BASE = [
  ...CON_ROL_DE_APP,
  ...CON_ROL_DUENO,
  ...E2E_CON_ROL_DE_APP,
  ...EVAL_RAG,
