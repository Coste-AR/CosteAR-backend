export interface paths {
    ...
    "/ordenes-trabajo/{id}/presupuestos": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
                        ...
                        "application/json": {
                            data: {
                                presupuestos: ({
                                    ...
                                    ordenId: string;
                                    /** @enum {string} */
                                    tipo: "BASE" | "ADICIONAL" | "REVISION";
                                    numero: number;
                                    /** @enum {string} */
                                    estado: "BORRADOR" | "PREPARADO" | "APROBADO" | "RECHAZADO" | "VENCIDO";
                                } & {
                                    [key: string]: unknown;
                                })[];
                                precioContractual?: number;
                                costoPrevistoTotal: number;
                            };
                        };
                    };
                };
            ...
            requestBody: {
                content: {
                    "application/json": {
                        ...
                        precio: number;
                        plazoDias: number;
                        causaAdicional?: string | null;
                        renglones: {
                            /** @enum {string} */
                            elemento: "MP" | "MOD" | "CIP" | "TERCEROS" | "ENTREGA";
                            /** Format: uuid */
                            etapaId?: string | null;
                            cantidad: number;
                            /** Format: uuid */
    ...
    "/ordenes-trabajo/{id}/partes-horas": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/ordenes-trabajo/{id}/costos-directos": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
                    ...
                    content: {
                        "application/json": {
                            data: ({
                                ...
                                importe: number;
                                /** @enum {string} */
                                estadoValidacion: "PENDIENTE" | "VALIDADO" | "MARCADO";
                                impactaCosto: boolean;
                            } & {
                                [key: string]: unknown;
                            })[];
                            resumen: {
                                totalValidado: number;
                                entregaInstalacionValidada: number;
                            };
                        };
                    };
                };
            ...
            requestBody: {
                content: {
                    "application/json": {
                        ...
                        etapaId: string;
                        /** @enum {string} */
                        categoria: "TERCEROS" | "TRANSPORTE" | "GRUA" | "VIATICOS" | "COMPRA_EXCLUSIVA" | "OTRO";
                        importe: number;
    ...
    "/ordenes-trabajo/{id}/contingencias": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
                ...
                200: {
                    ...
                    content: {
                        "application/json": {
                            ...
                            resumen: {
                                perdidaPeriodoValidada: number;
                                cifPoolValidado: number;
                                adicionalValidado: number;
                            };
                        };
                    };
                };
            ...
            requestBody: {
                content: {
                    "application/json": {
                        ...
                        etapaId: string;
                        /** @enum {string} */
                        tipo: "DESPERDICIO" | "SOBRANTE" | "ROTURA" | "FALLA" | "RETRABAJO";
                        cantidad: number;
                        valor: number;
                        recupero?: number | null;
                        causa: string;
                        tratamiento: string;
                        /** Format: uuid */
                        versionPresupuestoId?: string | null;
                    };
                };
            };
            responses: {
    ...
    "/companies/{companyId}/movimientos-inventario": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
