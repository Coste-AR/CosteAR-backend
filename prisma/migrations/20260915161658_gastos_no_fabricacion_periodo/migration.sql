...
-- AlterTable
ALTER TABLE "cost_periods" ADD COLUMN     "gastoFijoAdministracion" DECIMAL(18,4) NOT NULL DEFAULT 0,
ADD COLUMN     "gastoVariableComercializacionPorUnidad" DECIMAL(18,4) NOT NULL DEFAULT 0;